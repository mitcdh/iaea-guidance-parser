...
def test_title_inference_uses_descriptive_filename_for_incompatible_short_gibberish(tmp_path):
    pdf = tmp_path / "NSS 3 Monitoring for Radioactive Material in International Mail Transported by Public Postal Operators.pdf"
    pdf.write_bytes(b"not a real pdf")
    pages = [
        PageText(
            pdf_page=1,
    ...
    assert metadata.title == "Monitoring For Radioactive Material In International Mail Transported By Public Postal Operators"
...
def test_title_inference_uses_compatible_filename_to_restore_omitted_title_words(tmp_path):
    pdf = tmp_path / "SSG-26 Advisory Material for the IAEA Regulations for the Safe Transport of Radioactive Material (2018 Edition).pdf"
    pdf.write_bytes(b"not a real pdf")
    pages = [
        PageText(
            pdf_page=1,
    ...
    assert metadata.title == "Advisory Material For The Iaea Regulations For The Safe Transport Of Radioactive Material (2018 Edition)"
