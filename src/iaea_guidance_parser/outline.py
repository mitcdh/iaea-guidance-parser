...
def wording(text):
    # Compatibility folding erases exponents/subscripts; case folding can turn
    # mSv into MSv. Neither is acceptable evidence of exact source wording.
...
def structural_proof(document, page_number, records, source_text):
    ...
    for record in records:
        ...
        root = wording(active[0]).casefold() if active else ""
